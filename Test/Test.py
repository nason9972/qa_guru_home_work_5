...
def test_registration_form(config_browser):
    ...
    browser.element('.table').should(have.text('ivanov@example.com'))
    browser.element('.table').should(have.text('Male'))
    browser.element('.table').should(have.text('7929100500'))
    browser.element('.table').should(have.text('25 November,1986'))
    browser.element('.table').should(have.text('Maths'))
    browser.element('.table').should(have.text('Sports'))
    browser.element('.table').should(have.text('Moscow, st.Lenina, 23'))
